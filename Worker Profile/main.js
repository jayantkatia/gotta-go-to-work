let states = ["Not Specified","Andhra Pradesh",
    "Arunachal Pradesh",
    "Assam",
    "Bihar",
    "Chhattisgarh",
...
let exp=["Not Specified",0,1,2,3,4,5,6,'more than 6 yrs'];
let workerExp=document.getElementById("workerExp");

let category=["Not Specified","Electrician","Plumber","Carpenter","Painter","Repairman","Internet Services","Computer Technician","Manager","Personal Trainer","Home Barber services"];
